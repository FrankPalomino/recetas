...
function loadXMLDoc(url) {
  ...
  xmlhttp.onreadystatechange = () => {
    if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
      ...
      const ingredientsArray = elementoXmlhttpDevuelto.getElementsByTagName("ingredient");
      const tagBlurbArray = elementoXmlhttpDevuelto.getElementsByTagName("blurb");
      const tagGenreArray = elementoXmlhttpDevuelto.getElementsByTagName("genre");
      const tagAuthorArray = elementoXmlhttpDevuelto.getElementsByTagName("author");
      const tagYieldArray = elementoXmlhttpDevuelto.getElementsByTagName("yield");
      const tagPreptimeArray = elementoXmlhttpDevuelto.getElementsByTagName("preptime");
      const tagTitleArray = elementoXmlhttpDevuelto.getElementsByTagName("title");
      const fotoXMLString = elementoXmlhttpDevuelto.getElementsByTagName("img")[0].firstChild.nodeValue;
      const preparacioArray = elementoXmlhttpDevuelto.getElementsByTagName("preparation");
      const presentacioArray = elementoXmlhttpDevuelto.getElementsByTagName("serving");
      const notesArray = elementoXmlhttpDevuelto.getElementsByTagName("notes");
      ...
      ******************/
      ...
      tagImgDom.setAttribute("src", "recipes/" + fotoXMLString);
